...
// The login password comes only from the environment — no baked-in default.
// When it's unset the gate is off (e.g. a fresh checkout without .env.local).
...
export async function proxy(request: NextRequest) {
  // No password configured → gate off, let everything through.
